package com.ghf.exchange.otc.advertisebusiness.entity;
 ...
 */
@ApiModel
@Table(name = "t_advertise_business")
@Entity
...
public class AdvertiseBusiness {
    ...
    @Column(name = "advertise_business_code")
    ...
    @ApiModelProperty("上架的广告数量")
    @Column(name = "advertise_put_on_shelves_count")
