...
public class CoinController {
    ...
    @ApiOperation(value = "分页搜索币种", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "管理员分页搜索币种", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "列出币种", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "管理员列出币种", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "微服务客户端列出币种", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "根据币种编号获取账户详情", notes = "<p> 查询所有 coin 挂单配置信息 \n 查询所有可用 coin 信息 </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "根据币种编号判断币种是否存在", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "管理员新建币种", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "管理员更新币种", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "管理员启用币种", notes = "<p> </p>", httpMethod = "POST")
    ...
    @ApiOperation(value = "管理员停用币种", notes = "<p> </p>", httpMethod = "POST")
