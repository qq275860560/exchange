...
/**
 * @Author: ouyang
 * @Date: 2021/8/31 上午11:10
 * @Description:
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@ApiModel
@Data
public class SliderValidateCodeRespDTO {
    ...
    @ApiModelProperty("小图(Base64编码)")
    private String smallImage;

    @ApiModelProperty("大图(Base64编码)")
    private String bigImage;

    @ApiModelProperty("大图宽度")
    private int bigImageWidth;

    @ApiModelProperty("大图高度")
