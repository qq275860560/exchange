...
(
    ...
    order_coin_code VARCHAR(16)         DEFAULT NULL comment '订单数字货币编码',
    order_coin_name  VARCHAR(16)         DEFAULT NULL comment '订单数字货币名称',
    order_coin_unit  VARCHAR(16)         DEFAULT NULL comment '订单数字货币单位',
    order_coin_rate DECIMAL(18,8) DEFAULT NULL comment '订单数字货币交易手续费比例',
    ...
    order_customer_payment_type_bank_branch_name VARCHAR(64)   DEFAULT NULL comment '订单顾客支持的付款条件:银行方式,支行名称',
    ...
    advertise_coin_code  VARCHAR(16)         DEFAULT NULL comment '广告数字货币编码',
    advertise_coin_name  VARCHAR(16)         DEFAULT NULL comment '广告数字货币名称',
    advertise_coin_unit  VARCHAR(16)         DEFAULT NULL comment '广告数字货币单位',
    advertise_coin_rate DECIMAL(18,8) DEFAULT NULL comment '广告数字货币交易手续费比例',
    ...
    advertise_business_payment_type_bank_branch_name VARCHAR(64)   DEFAULT NULL comment '广告商家支持的付款条件:银行方式,支行名称',
