...
(
    ...
    advertise_coin_code  VARCHAR(16)         DEFAULT NULL comment '数字货币编码',
    advertise_coin_name  VARCHAR(16)         DEFAULT NULL comment '数字货币名称',
    advertise_coin_unit  VARCHAR(16)         DEFAULT NULL comment '数字货币单位',
    advertise_coin_rate DECIMAL(18,8) DEFAULT NULL comment '数字货币交易手续费比例',
